...
const PLACEHOLDER_QUERIES = [
  ...
  "Does Vedant do photography?",
  "What are Vedant's hobbies?",
  "What is Vedant's strongest skill?",
  "Tell me about WordSense AI...",
  "What is FocusForge?",
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const currentQuery = PLACEHOLDER_QUERIES[queryIndex];
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center selection:bg-neutral-200">
      ...
      <div
        className={cn(
          "relative z-10 flex w-full max-w-3xl flex-col px-4",
          messages.length === 0
